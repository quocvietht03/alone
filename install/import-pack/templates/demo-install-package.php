...
<div class="ip-package-demo-list">
    ...
    <div class="ip-package-demo-item">
        <div class="preview-image">
            ...
            <div class="actions">
                <a href="<?php echo esc_url( $package_item['url_demo'] ) ?>" target="_blank" class="__action-preview-demo" title="<?php echo esc_attr( 'Preview demo', 'alone' ); ?>">
                    <?php _e( 'Preview', 'alone' ); ?>
                </a>
                <a href="javascript:" class="__action-import-demo" title="<?php echo esc_attr( 'Import demo', 'alone' ); ?>" data-package-id="<?php echo esc_attr( trim( $package_item['package_name'] ) ); ?>">
                    <?php _e( 'Import', 'alone' ); ?>
                </a>
            </div>
        </div>
        ...
        <div class="entry">
            <h4 class="title">
                <a href="<?php echo esc_url( $package_item['url_demo'] ) ?>" target="_blank">
                    ...
                    <svg style="width: 20px;" x="0px" y="0px" viewBox="0 0 476.213 476.213" style="enable-background:new 0 0 476.213 476.213;" xml:space="preserve"> <polygon points="345.606,107.5 324.394,128.713 418.787,223.107 0,223.107 0,253.107 418.787,253.107 324.394,347.5 345.606,368.713 476.213,238.106 "/></svg>
                </a>
            </h4>
        </div>
    </div>
